...
ActiveRecord::Schema.define(version: 2022_06_09_104012) do
  ...
  create_table "ground_players", force: :cascade do |t|
    ...
    t.index ["ground_id"], name: "index_ground_players_on_ground_id"
    t.index ["user_id"], name: "index_ground_players_on_user_id"
  end
